...
Позволяет вернуться к любому историческому коду в репозитории, так же возможна командная работа, работа с ветками и тп (для отслеживания изменений исходного кода с течением времени)
