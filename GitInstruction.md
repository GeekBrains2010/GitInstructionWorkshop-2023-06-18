...
Установка клиентских средств для Git. Пакет установки включает систему управления версиями Git и приложение ... Чтобы запустить VS Code и открыть текущую папку, выполните команду code . в командной строке или оболочке Bash
